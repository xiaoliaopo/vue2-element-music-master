...
export default {
  ...
  created(){
    //获取mv地址
    axios({
      url:"http://cloud-music.pl-fe.cn/mv/url",
      method:"get",
      params:{
    ...
    //获取相关mv
    axios({
      url:"http://cloud-music.pl-fe.cn/simi/mv",
      method:"get",
      params:{
    ...
    //获取mv信息
    axios({
      url:"http://cloud-music.pl-fe.cn/mv/detail",
      method:"get",
      params:{
        mvid:this.$route.query.q
      }
      ...
      //获取歌手信息
      axios({
        url:"http://cloud-music.pl-fe.cn/artists",
        method:"get",
        params:{
  ...
  methods: {
     getMvList(){
     axios({
      url:' http://cloud-music.pl-fe.cn/comment/mv',
      method:'get',
      params:{
        id:this.$route.query.q,
        limit:this.limit,
